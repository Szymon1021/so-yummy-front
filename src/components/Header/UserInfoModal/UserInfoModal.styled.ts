...
import { IUserInfoModalProps } from './UserInfoModal';
...
export const ModalWrapper = styled.div<Pick<IUserInfoModalProps, 'isShown'>>`
  position: absolute;
  top: 50%;
  left: 50%;
...
export const ErrorMessage = styled.p<{ location?: string }>`
  position: absolute;
  color: red;
  top: 50%;
